...
class Hierarchical2 extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener, ActionListener {
 ...
 /* Define more models you need for constructing your scene */
    ...
    private double theta1 = -25f;
    private double theta2 = -23.5f;
    private double theta3 = -22f;
    private double theta4 = -20.5f;
    private double theta5 = -19f;
    private double theta6 = -17.5f;
    private double theta7 = -16f;
        ...
        gl.glPushMatrix();	// push the current matrix to stack
	        ...
	        gl.glPushMatrix();
	        	...
	        	gl.glPushMatrix();
		    		...
		    		gl.glScalef(0.5f, 0.25f, 8.0f);
		    		gl.glTranslatef(-1.05f, 0.0f, 0.04f);
		    		glut.glutSolidSphere(0.04f, 25, 25);
	        	gl.glPopMatrix();
	        ...
	        gl.glPushMatrix();
	        	...
	        	gl.glTranslatef(0.40f, 0.0f, 0.0f);
	        	// Fifth Wings
	        	gl.glPushMatrix();
	        		gl.glColor3f(0.0f, 1.0f, 0.0f);
...
//        example_model2.Draw();
        ...
        if (animator.isAnimating()) {
        	theta1 += 1.001 * animation_speed;
        	theta2 += 1.002 * animation_speed;
        	theta3 += 1.003 * animation_speed;
        	theta4 += 1.004 * animation_speed;
        	theta5 += 1.005 * animation_speed;
        	theta6 += 1.006 * animation_speed;
        	theta7 += 1.007 * animation_speed;
        	...
        	translate_box1 = (float)(0.05 * Math.sin(Math.toRadians(theta1)));
        	translate_box2 = (float)(0.06 * Math.sin(Math.toRadians(theta1)));
        	translate_box3 = (float)(0.07 * Math.sin(Math.toRadians(theta1)));
        	translate_box4 = (float)(0.08 * Math.sin(Math.toRadians(theta1)));
        	translate_box5 = (float)(0.09 * Math.sin(Math.toRadians(theta1)));
        	translate_box6 = (float)(0.10 * Math.sin(Math.toRadians(theta1)));
    ...
    public Hierarchical2() {
        super("Assignment 2 -- Hierarchical Modeling -- second");
